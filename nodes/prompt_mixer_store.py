"""
Prompt Mixer Store - isolated JSON storage for Prompt Mixer fragments.

This module provides a separate data file (prompt_mixer_data.json) and backend
endpoints so the Prompt Mixer nodes do not share the main Prompt Manager library.
"""
import json
import os
import shutil
...
class PromptMixerStore:
    ...
    @staticmethod
    def get_data_path():
        """Path to the prompt mixer JSON file in the user's default folder."""
    ...
    def get_default_prompts_path():
        """Path to the bundled default mixer prompts JSON file."""
